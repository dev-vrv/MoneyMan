            ...
            return (
              ...
              >
                <button
                  ...
                  className={clsx(
                    "group relative h-full w-full overflow-hidden rounded-[1.8rem] border px-6 py-7 text-left backdrop-blur-2xl transition duration-500 ease-out",
                    meta.tone,
                    isActive
                ...
                >
                  ...
                  <div className="absolute inset-x-6 bottom-9 h-px bg-white/8" />
                  ...
                  <div className="relative z-10 flex h-full flex-col pb-5">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="rounded-full border border-white/10 bg-white/6 px-3 py-1 text-[0.62rem] uppercase tracking-[0.16em] text-white/64">
                        {card.metric}
                      </div>
                    </div>
                    ...
                    <div className="flex flex-1 flex-col">
                      ...
                      <h3 className="mt-2 max-w-[13rem] text-xl font-semibold tracking-tight text-white">
                        {card.title}
                      </h3>
                      <p className="mt-3 max-w-[16rem] flex-1 text-sm leading-6 text-white/74">
                        {card.description}
                      </p>
                    </div>
                    ...
                    <div className="mt-6 flex items-center justify-between">
                      ...
                      <div className="text-[0.68rem] uppercase tracking-[0.16em] text-white/44">
                        {card.accent}
                      </div>
                    </div>
      ...
      >
        {activeCard && activeMeta ? (
          <DialogContent
            showCloseButton
            className={clsx(
              "max-h-[calc(100vh-2rem)] overflow-y-auto rounded-[1.9rem] border p-0 sm:max-w-3xl",
