...
export function HeroSideWidget({ copy }: HeroSideWidgetProps) {
  return (
    <div className="relative h-full min-w-0 select-none">
      <div className="hero-side-widget relative flex h-full min-h-[32rem] flex-col overflow-hidden rounded-[1.75rem] border border-white/10 p-4 backdrop-blur-2xl sm:p-5">
        ...
        <div className="relative z-10 flex min-w-0 items-start justify-between gap-3">
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-2 break-words text-[0.95rem] leading-6 text-white/72">
              {copy.description}
            </div>
          </div>
        ...
        <div className="relative z-10 mt-5 flex min-w-0 flex-1 flex-col gap-4 sm:flex-row sm:items-center">
          ...
          <div className="min-w-0 flex-1 self-stretch space-y-2.5">
            <div className="hero-float flex min-h-[5.7rem] min-w-0 flex-col justify-center rounded-[1rem] border border-white/8 bg-white/[0.04] px-3 py-3">
              <div className="mb-1 break-words text-[0.58rem] tracking-[0.08em] text-cyan-100/65">
                {copy.focusLabel}
              </div>
              <div className="break-words text-[1rem] font-semibold leading-5 tracking-tight text-white">
                {copy.focusValue}
              </div>
            </div>

            <div className="grid gap-2.5 sm:grid-cols-2">
              <div className="hero-float hero-float-delay flex min-h-[5.7rem] min-w-0 flex-col justify-center overflow-hidden rounded-[1rem] border border-fuchsia-300/15 bg-fuchsia-300/10 px-3 py-3 text-white/88">
                <div className="mb-1 break-words text-[0.58rem] tracking-[0.08em] text-white/58">
                  {copy.pulseLabel}
                </div>
                <div className="break-words text-[1rem] font-semibold leading-5">
                  {copy.pulseValue}
                </div>
              </div>
              <div className="hero-float flex min-h-[5.7rem] min-w-0 flex-col justify-center overflow-hidden rounded-[1rem] border border-amber-300/15 bg-amber-300/10 px-3 py-3 text-white/88">
                <div className="mb-1 break-words text-[0.58rem] tracking-[0.08em] text-white/58">
                  {copy.controlLabel}
                </div>
                <div className="flex min-w-0 items-start gap-1.5 text-[1rem] font-semibold leading-5">
        ...
        <div className="relative z-10 mt-4 flex min-h-[4.25rem] flex-wrap content-start gap-2">
