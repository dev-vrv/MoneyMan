...
export function MarketingInfoPageExperience({
  ...
  return (
    <>
      <section
        id="page-overview"
        className="relative z-10 flex min-h-[calc(100vh-5rem)] items-center py-14 lg:py-20"
      >
      ...
      <section id="page-core" className="relative z-10 py-20">
        <HomeSectionHeading
      ...
      {secondarySection ? (
        <section id="page-details" className="relative z-10 py-20">
                ...
                {secondarySection.cards.map((card, index) => {
                  ...
                  return (
                    <ScrollReveal
                      ...
                      blur={12}
                    >
                      <article className="relative h-full overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(8,14,18,0.92),rgba(6,10,14,0.98))] p-6 transition duration-300 hover:-translate-y-1 hover:border-cyan-300/20">
      ...
      {faqSection ? (
        <section id="page-faq" className="relative z-10 py-20">
          <div className="grid gap-10 xl:grid-cols-[minmax(0,0.82fr)_minmax(0,1fr)] xl:items-start">
            <div className="rounded-[2.2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(8,14,18,0.92),rgba(6,10,14,0.98))] p-6 sm:p-7">
              ...
              <div className="mt-8 space-y-3">
                {faqSection.items.slice(0, 3).map((item, index) => (
                  <div
